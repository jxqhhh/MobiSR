...
public class DSPSuperResolutionService extends IntentService {
    ...
    private static final String LOG_TAG = DSPSuperResolutionService.class.getSimpleName();
    private static final String ACTION_DSP = "DSP";

    public DSPSuperResolutionService() {
        super("DSPSuperResolutionService");
