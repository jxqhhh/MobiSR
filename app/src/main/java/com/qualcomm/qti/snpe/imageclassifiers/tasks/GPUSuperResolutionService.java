...
public class GPUSuperResolutionService extends IntentService {
    ...
    private static final String LOG_TAG = GPUSuperResolutionService.class.getSimpleName();
    private static final String ACTION_GPU = "GPU";

    public GPUSuperResolutionService() {
        super("GPUSuperResolutionService");
    ...
    public static void processPatch(Context context, Bitmap bitmap) {
        ...
        Intent intent = new Intent(context, GPUSuperResolutionService.class);
        intent.setAction(ACTION_GPU);
